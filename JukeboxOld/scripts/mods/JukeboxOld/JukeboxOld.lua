...
mod:io_dofile("JukeboxOld/scripts/mods/JukeboxOld/modules/servitor_skull")
mod:io_dofile("JukeboxOld/scripts/mods/JukeboxOld/modules/insert_localization")
mod:io_dofile("JukeboxOld/scripts/mods/JukeboxOld/modules/insert_blueprints")
mod:io_dofile("JukeboxOld/scripts/mods/JukeboxOld/modules/jukebox_view_register")
mod:io_dofile("JukeboxOld/scripts/mods/JukeboxOld/modules/dance")
mod:io_dofile("JukeboxOld/scripts/mods/JukeboxOld/modules/disco")

local music_tracks = mod:io_dofile("JukeboxOld/scripts/mods/JukeboxOld/modules/music_tracks")
local mod_widgets = mod:io_dofile("JukeboxOld/scripts/mods/JukeboxOld/JukeboxOld_data").options.widgets
...
mod:command("stop_mission_sounds", "Stop all mission sounds", function()
	local world = Managers.ui:world()
	local wwise_world = Managers.world:wwise_world(world)
	WwiseWorld.trigger_resource_event(wwise_world, "wwise/events/world/stop_all_mission_sounds")
end)
