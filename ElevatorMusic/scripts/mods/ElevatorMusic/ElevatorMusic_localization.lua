return {
	...
	enable_for_ascension_riser = {
		["en"] = "Ascension Riser",
		["zh-cn"] = "大型升降机",
	},
	enable_for_ascension_riser_tooltip = {
		["en"] = "Play Muzak while riding the Ascension Riser. It's a glorified lift, right?",
		["zh-cn"] = "搭乘大型升降机时也播放电梯音乐。只不过是一种更神圣的电梯，不是吗？",
	},
}
