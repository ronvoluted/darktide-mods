return {
	...
	log_to_chat_tooltip = {
		...
		["zh-cn"] = "只有开发者控制台会显示音频类型（例如“source_sound”、“3d_sound”）。注意：与“详细事件日志”选项不兼容。",
	},
	log_wwise = {
	...
	log_wwise_verbose_tooltip = {
		...
		["zh-cn"] = "对每个事件，记录包含所有参数的表（table）。注意：与“在聊天窗口中输出日志”选项不兼容。",
	},
}
