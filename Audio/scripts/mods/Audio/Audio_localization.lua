return {
	...
	log_silenced = {
		...
		["ru"] = "Включать отключённые звуки в журнал Wwise",
	},
	log_silenced_tooltip = {
		["en"] = "Log voicelines and sound events even if they have been silenced by Audio mods",
		["ru"] = "Записывать в лог голосовые сообщения и звуковые события, даже если они были отключены аудиомодами",
	},
	log_to_chat = {
		["en"] = "Log to chat window instead of developer console",
		["ru"] = "Показывать лог в окне чата вместо консоли разработчика",
	},
	log_to_chat_tooltip = {
		...
		["ru"] = "Только консоль разработчика будет отображать тип звука (например, \"source_sound\", \"3d_sound\"). ПРИМЕЧАНИЕ: Несовместимо с опцией \"Подробная регистрация событий\".",
	},
	log_wwise = {
